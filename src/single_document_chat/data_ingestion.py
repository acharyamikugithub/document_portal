...
class SingleDocIngester:
    def __init__(self,data_dir:str="data/single_document_chat",faiss_dir: str="faiss_index"):
        try:
            ...
            self.log.info("SingleDocIngestor intialized",temp_path=(self.data_dir),faiss_path=str(self.faiss_dir))
    ...
    def _create_retriever(self,documents):
        try:
            splitter=RecursiveCharacterTextSplitter(chunk_size=100,chunk_overlap=300)
